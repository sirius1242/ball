...
MACRO_CONFIG_INT(SvArmorClock, sv_armor_clock, 1, 0, 1, CFGFLAG_SERVER, "Use armor to clock instead of extra ball keep time")
MACRO_CONFIG_INT(SvBallType, sv_balltype, 3, 2, 4, CFGFLAG_SERVER, "Ball Type (default 3:grenade; others, 2:shotgun; 4:laser)")
